...
<div class="box-area">
    ...
    <div class="banner-area">
        <h2>GIVING</h2>
        <h3>Is the greatest act of grace !</h3>
        ...
        <form>
            <div class="form-box">
                ...
                <select class="search-field location" name="city" >
    ...
    <div class="content-area">
        <div class="wrapper">
            <h2>Descriptif</h2>
            <p>texte est une série orale ou écrite de mots perçus comme constituant
                porteur de sens et utilisant les structures propres à une constituant
                texte est une série orale ou écrite de mots perçus comme constituant
                porteur de sens et utilisant les structures propres à une constituant
                texte est une série orale ou écrite de mots perçus comme constituant
                porteur de sens et utilisant les structures propres à une constituant</p>
        </div>
        <div class="container">
            <div class="box">
                <div class="icon">
                ...
                <div class="content">
                    <h3><a href="">ALL</a> </h3>
                    <p> Tous les offres quelque soit la catégorie fgfhyjhg ghtyjukjyh
                        ghfjyugkjhghjh fdghjhk ghyyujkh rtyyui ghjkhlj qrtytfugi sqdfhj
                    </p>
                </div>
            </div>
            <div class="box">
